...
( \
  echo 'src/gz %d_core https://openwrtdata.agustinls.com/nss-wifi-unified/20260713/packages'; \
  $(strip $(if $(CONFIG_PER_FEED_REPO), \
...
( \
  echo 'https://openwrtdata.agustinls.com/nss-wifi-unified/20260713/packages/packages.adb'; \
  $(strip $(if $(CONFIG_PER_FEED_REPO), \
